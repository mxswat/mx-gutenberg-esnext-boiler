...
function __registerBlockFunctionName____register_block() {
	...
	wp_register_script(
		'plugin-prefix-plugin-name-internal',
	...
	wp_register_style(
		'plugin-prefix-plugin-name-internal-editor',
	...
	register_block_type( 'plugin-prefix/plugin-name-internal', array(
		'style' => 'plugin-prefix-plugin-name-internal',
		'editor_style' => 'plugin-prefix-plugin-name-internal-editor',
		'editor_script' => 'plugin-prefix-plugin-name-internal',
	) );
